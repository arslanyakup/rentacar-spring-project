...
public class CarServiceImpl implements CarService {
	...
	public List<Car> getCarListByUsername(String username) {
		return carRepository.getCarListByUsername(username);
	}

	@Override
	public List<Car> getCarListByRankAndSelectedCity(String username) {
		return carRepository.getCarListByRankAndSelectedCity(username);
	}

	@Override
	public List<Car> getCarListBySelectedState(String statename) {
		return carRepository.getCarListBySelectedState(statename);
	}
}
