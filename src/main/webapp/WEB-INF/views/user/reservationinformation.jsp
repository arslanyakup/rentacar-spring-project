...
<!-- Head BEGIN -->
<head>
<title>Rezervasyon Bilgisi</title>
<!-- Favicon -->
	...
	<div class="wrapper">
		<div class="container">
			...
			<div class="col-md-8" style="margin-top: 100px;">
				<h1 style="font-family: fantasy; color: #2F9296;">Rezervasyonunuz
					işleme alınmıştır.</h1>
				<h3 style="font-family: inherit; color: #2F9296;">Onaylanma
					durumunda size e-posta yoluyla geri bildirim sağlanacaktır!</h3>

				<div class="portlet box green-meadow" style="margin-top: 50px;">
						...
						<div>
							<div class="col-md-12">
								...
								<h4
									...
									Bilgileri:
									&nbsp;${newReservation.car.brand}&nbsp;${newReservation.car.model}&nbsp;,${newReservation.car.year}&nbsp;Model&nbsp;,
									${newReservation.car.fueltype}&nbsp;yakıt&nbsp;,${newReservation.car.geartype}&nbsp;vites&nbsp;,
									${newReservation.car.capacity}&nbsp;kişilik</h4>
							</div>
						</div>
					</div>
				</div>
