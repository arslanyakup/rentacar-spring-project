							...
							<div class="col-md-12">
								...
								<div class="tab-content" style="height: 1050px;">
									<div id="tab_1-1" class="tab-pane active">
										<form:form modelAttribute="newUser" action="registeruser"
												   enctype="multipart/form-data" method="POST">
											<div class="form-group">
												<label class="control-label">Ad</label>
												<form:errors cssStyle="color: #B40404" path="firstname"/>
												<form:input path="firstname" type="text"
															class="form-control" />
											</div>
											<div class="form-group">
												<label class="control-label">Soyad</label>
												<form:errors cssStyle="color: #B40404" path="lastname"/>
												<form:input path="lastname" type="text"
															class="form-control" />
											</div>
											<div class="form-group">
												<label class="control-label">Kullanıcı Adı</label>
												<form:errors cssStyle="color: #B40404" path="username"/>
												<span id="usererror" style="color: #ff0000"></span>
												<form:input id="username" onblur="getUserBy()" path="username" type="text"
															class="form-control" />
											</div>
											<div class="form-group">
												<label class="control-label">Şifre</label>
												<form:errors cssStyle="color: #B40404" path="password"/>
												<form:input path="password" type="password"
															class="form-control" />
											</div>
											<div class="form-group">
												<label class="control-label">Telefon</label>
												<form:errors cssStyle="color: #B40404" path="telephone"/>
												<form:input id="mask_phone" path="telephone" value="${user.telephone}"
															type="text" class="form-control" />
											</div>
											<div class="form-group">
												<label class="control-label">E-Mail</label>
												<form:errors cssStyle="color: #B40404" path="email"></form:errors>
												...
												<div class="col-md-3">
													<div class="margin-top-10; margin-bottom-10">
														<button style="background-color: #2F9296; border: 0px; width: 115px;"
																type="submit" class="btn btn-primary btn-lg btn-block">KAYDOL</button>
													</div>
												</div>
											</div>
										</form:form>
...
<script src="<%=request.getContextPath()%>/resources/jquery-inputmask/jquery.inputmask.bundle.min.js"></script>
<script src="<%=request.getContextPath()%>/resources/jquery-inputmask/inputmask/form-input-mask.min.js"></script>
<script src="<%=request.getContextPath()%>/resources/jquery-inputmask/inputmask/app.min.js"></script>
<!-- END JAVASCRIPTS -->
</body>
<!-- END BODY -->
</html>
