	...
	<div class="wrapper">
		<div class="container" style="margin-bottom: 30px;">
			...
			<div class="col-md-8" style="margin-top: 100px;">
				<h1 style="font-family: fantasy; color: #2F9296;">Rezervasyon
					işlemi başarıyla onaylandı.</h1>
				<h3 style="font-family: inherit; color: #2F9296;">Aracı
					kiralamak isteyen kişiyle lütfen iletişim halinde olunuz.</h3>
				<div class="col-md-6">
					<div class="portlet box green-meadow"
						style="margin-top: 50px; width: 335px;">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-thumbs-up"></i>Rezervasyon Bilgileri
							</div>
						</div>
						<div style="height: 260px;" class="portlet-body">
							<div>
								<div class="col-md-12">
									<h4
										style="font-family: inherit; color: black; margin-top: 10px;">Adres:&nbsp;
										${newReservation.receptionLocation.city},&nbsp;${newReservation.receptionLocation.district}&nbsp;${newReservation.receptionLocation.locationname}&nbsp;${newReservation.receptionLocation.wideAddress}</h4>
									<br />
									<h4
										style="font-family: inherit; color: black; margin-top: 10px;">Alış
										Tarihi:&nbsp;${newReservation.datest}</h4>
									<br />
									<h4
										style="font-family: inherit; color: black; margin-top: 10px;">İade
										Tarihi:&nbsp;${newReservation.dateend}</h4>
									<br />
									<h4
										style="font-family: inherit; color: black; margin-top: 10px;">Araç
										Bilgileri:
										&nbsp;${newReservation.car.brand}&nbsp;${newReservation.car.model}
				...
				<div class="col-md-6">
					<div class="portlet box green-meadow"
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-thumbs-up"></i>Alıcı Bilgileri
							</div>
						</div>
						<div style="height: 260px;" class="portlet-body">
							<div>
								<div class="col-md-12">
									<h4
										style="font-family: inherit; color: black; margin-top: 10px;">
										Ad-Soyad:&nbsp; ${user.firstname}&nbsp;${user.lastname} <img
											style="width: 40px; height: 40px; margin-left: 20px;" alt=""
											class="img-rounded"
											src="<%=request.getContextPath()%>/resources/resim/user-image/${user.imagePath}">
									</h4>
									<br />
									<h4
										style="font-family: inherit; color: black; margin-top: 10px;">E-Mail:&nbsp;${user.email}</h4>
									<br />
									<h4
										style="font-family: inherit; color: black; margin-top: 10px;">Adres:&nbsp;
										${user.address.city},&nbsp;${user.address.district},&nbsp;${user.address.wideAddress}
									</h4>
									<a href="<%=request.getContextPath()%>/user/profile/${user.username}"
										style="background-color: #2F9296; border: 0px;width: 150px;margin-right: 0px;margin-left: 150px;" type="submit"
										class="btn btn-primary btn-lg btn-block">Profiline git </a>
								</div>
							</div>
						</div>
					</div>
