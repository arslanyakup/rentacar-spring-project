...
<body class=" login">
	...
	<div class="logo">
		...
		<a href="${url}"> <img style="width: 100px;"
			src="<%=request.getContextPath()%>/resources/themefolder1/assets/frontend/layout/img/logos/arabalik.png"
			alt="" />
		</a>
	</div>
	<!-- END LOGO -->
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<h3 style="color: #379B9F;" class="form-title font-green">Giriş Yap</h3>
		...
		<form class="login-form" action="login" method="post">
			...
			<div class="form-group">
				<label class="control-label visible-ie8 visible-ie9">Kullanıcı Adı</label> <input
			...
			<div class="form-actions">
				<button style="background-color: #2F9296; border: 0;" type="submit" class="btn green uppercase">Giriş Yap</button>
				<button style="float: right;background-color: #2F9296;border:0;" type="submit" class="btn green uppercase">
					<a style="color: white;" href="<%=request.getContextPath()%>/">Anasayfa</a>
				</button>
			</div>

			<div style="background-color: #31797C;" class="create-account">
				<p>
					<a type="button" href="<%=request.getContextPath()%>/user/register"
						id="register-btn" class="uppercase">Hesap oluşturmak için tıklayınız</a>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->
