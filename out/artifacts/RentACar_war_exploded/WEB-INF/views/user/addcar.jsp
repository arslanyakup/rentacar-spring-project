					...
					<div class="panel-body">
						...
						<form:form modelAttribute="newCar" class="form -dark"
							...
							<div class="form-group -warning">
								<label for="form-elements-select">Marka</label><br /> <b><form:errors
										path="brand" cssStyle="color:#ff0000;" /></b>
								<form:input class="form-control" path="brand" type="text"
									id="brand" placeholder="Marka..." />
							</div>
							<div class="form-group -warning">
								<label for="form-elements-select">Model</label><br /> <b><form:errors
										path="model" cssStyle="color:#ff0000" /></b>
								<form:input class="form-control" path="model" id="model"
									type="text" placeholder="Model..." />
							</div>
							<div class="form-group -warning">
								<label for="form-elements-text">Yıl</label><br /> <b><form:errors
										path="year" cssStyle="color:#ff0000" /></b>
							...
							<div class="form-group -warning">
								<label for="form-elements-select">Araç Yolcu Kapasitesi</label><br />
								<b><form:errors path="capacity" cssStyle="color:#ff0000" /></b>
								<form:input class="form-control" path="capacity" id="capacity"
									type="text" placeholder="" />
							</div>
							<div class="form-group -warning">
								<label for="form-elements-select">Günlük kira</label><br /> <b><form:errors
										path="price" cssStyle="color:#ff0000" /></b>
